...
export default function RegisterPage() {
  ...
  return (
    <>
      <MobileNavigation />
      <div className="h-[calc(100vh-5rem)] bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 relative overflow-hidden flex items-center justify-center">
        {/* Notification */}
        <Notification 
      ...
      <div className="w-full max-w-md px-4 py-6 z-10">
        {/* Header */}
