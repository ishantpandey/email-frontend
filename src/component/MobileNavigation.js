          ...
          <div className="flex items-center justify-between">
              ...
              {isAuthenticated && user ? (
                <div className="flex items-center space-x-4">
                  ...
                  <button 
                    ...
                    className="text-gray-600 hover:text-gray-900 transition-colors duration-200 hover:text-gray-900 transition-colors"
                  >
                    Logout
                  </button>
                </div>
            ...
            <div className="lg:hidden flex items-center space-x-3">
              {isAuthenticated && user ? (
                ...
                >
                  <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center ring-2 ring-blue-100 hover:ring-blue-200 transition-all">
          ...
          <div className="lg:hidden absolute top-full left-0 right-0 bg-white border-b border-gray-100 shadow-lg z-50">
            <div className="px-6 py-6 space-y-1">
              <button 
                ...
                className="flex items-center space-x-3 py-3 text-gray-700 hover:text-gray-900 transition-colors w-full text-left"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {isAuthenticated && user ? (
                ...
                <div className="pt-4 border-t border-gray-100 mt-4">
                  <button 
                    onClick={handleSignIn}
                    className="flex items-center justify-center space-x-2 w-full bg-indigo-600 text-white py-3 rounded-lg text-sm font-medium hover:bg-indigo-700 transition-colors"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
